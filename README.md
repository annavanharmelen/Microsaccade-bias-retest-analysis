# MICROSACCADE BIAS RETEST ANALYSIS
# ***[work in progress]***
Analysis scripts (in MATLAB) for the data acquired from the microsaccade bias retest experiment (in Python). For the experiment, see: [Microsaccade-bias-retest-experiment-main](https://github.com/annavanharmelen/Microsaccade-bias-retest-experiment).
